-- =====================================================================
-- ApplyOS — Onboarding + Dashboard Timelines (standalone copy)
--
-- STANDALONE FILE: paste this directly into the hosted Supabase SQL
-- Editor and run it. It is byte-for-byte identical to
-- supabase/migrations/20260710120000_onboarding_and_timelines.sql and
-- requires no other file. Run supabase/schema.sql first if this is a
-- brand-new project that has never been set up.
--
