...
- recruiterEmail/recruiterName/hiringManagerName must ONLY be populated when the posting clearly identifies a point of contact for THIS role (e.g. "Recruiter: Jane Doe", "For questions about this role, contact...", "Apply by emailing..."). A posting frequently contains OTHER email addresses that are not the recruiter's — disability/accommodation requests, legal, privacy, press, support/help desks, or generic automated mailboxes (careers@, jobs@, hr@, info@). Never populate recruiterEmail with one of those; leave it null instead. An email address existing somewhere in the text is not by itself evidence it belongs to a recruiter.
- sourcePlatform: if a source URL was provided separately, prefer that. Otherwise, detect the source job portal from copied page text when the evidence is unambiguous — e.g. LinkedIn-specific phrases like "Responses managed off LinkedIn", "Promoted by hirer", "Your AI-powered job assessment", "Tailor my resume", or "X people clicked apply"; Indeed/Glassdoor/Greenhouse/Lever/Workday/Ashby/SmartRecruiters/Taleo/iCIMS/Handshake/RippleMatch/WayUp/ZipRecruiter/Monster/Dice/eFinancialCareers/Built In and similar portal names or their characteristic UI text. Never confuse the employer/company name with the source platform (e.g. "Tower Research Capital" is the company; "LinkedIn" is the platform). If multiple platforms are mentioned, choose the one the posting was actually copied/posted from, not a footer, social-share, or legal/accommodation reference. Never invent a source platform without clear textual evidence — leave it null instead.
