 ...
 * to just the icon when dismissed. Scoped to wherever it's rendered
 * (the Add Application page only) rather than being a persistent fixture.
 */
export function JobIntelligenceLayout({ title, subtitle, icon, children }: JobIntelligenceLayoutProps) {
        ...
        {open && (
          <motion.div
            ...
            className={cn(
              ...
              "sm:inset-x-auto sm:right-6 sm:w-[420px]"
            )}
          >
